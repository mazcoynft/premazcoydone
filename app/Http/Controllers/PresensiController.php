...
class PresensiController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $sp = ($status_presensi == "onsite" || $status_presensi == "wfo") ? 1 : 0;
    ...
    public function cetaklaporan(Request $request)
{
    ...
    $bulan = $request->bulan;
    $tahun = $request->tahun;
    $namabulan = ["semua" => "Semua"] + array_combine(range(1, 12), ["Januari", "Februari", "Maret", "April", "Mei", "Juni", "Juli", "Agustus", "September", "Oktober", "November", "Desember"]);
    ...
    if ($bulan != "semua") {
        $presensiQuery->whereRaw('MONTH(tgl_presensi)="' . $bulan . '"');
    }

    if ($tahun != "semua") {
        $presensiQuery->whereRaw('YEAR(tgl_presensi)="' . $tahun . '"');
    }

    $presensi = $presensiQuery->orderBy('tgl_presensi')
        ->get();
