...
<div class="row">
    <div class="col">
       ...
       <div class="row">
            <div class="col-6">
                <button status_presensi="wfo" class="btn btn-danger btn-block takeabsen">
        ...
        @else
             ...
             <div class="row">
            <div class="col-6">
                <button status_presensi="wfo" class="btn btn-primary btn-block takeabsen">
                    <ion-icon name="camera-outline"></ion-icon>
                    Absen Masuk
                </button>
            </div>
...
<script>
    ...
    $.ajax({
        ...
        success: function(respond) {
            ...
            // Show the map after the AJAX call (assuming the response indicates success)
            successCallback({
                coords: {
                    latitude: parseFloat(lokasi.split(',')[0]),
                    longitude: parseFloat(lokasi.split(',')[1])
                }
            });
        }
    });
